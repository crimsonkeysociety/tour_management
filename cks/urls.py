...
urlpatterns = patterns('',
    ...
    url(r'^month/(?P<year>\d{4})/(?P<month>\d{1,2})/edit-initialization/$', views.edit_month_initialization, name='edit-month-initialization-url'),
    url(r'^month/(?P<year>\d{4})/(?P<month>\d{1,2})/uninitialize/$', views.uninitialize_month, name='uninitialize-month-url'),
    url(r'^month/(?P<year>\d{4})/(?P<month>\d{1,2})/uninitialize/(?P<confirm>\d+)/$', views.uninitialize_month, name='uninitialize-month-confirm-url'),
