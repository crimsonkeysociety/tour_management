...
urlpatterns = patterns('',
    ...
    url(r'^roster/(?P<year>\d{4})/(?P<semester>\w+)/$', 'app.views.roster', name='roster-url'),
    url(r'^roster/v-card/$', views.RosterVCardView.as_view(), name='roster-vcard-url-noargs'),
    url(r'^roster/(?P<year>\d{4})/(?P<semester>\w+)/v-card/$', views.RosterVCardView.as_view(), name='roster-vcard-url'),
