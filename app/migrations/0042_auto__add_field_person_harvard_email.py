...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.harvard_email'
        db.add_column(u'app_person', 'harvard_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.harvard_email'
        db.delete_column(u'app_person', 'harvard_email')
