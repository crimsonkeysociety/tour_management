...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_person', 'phone', self.gf('django.db.models.fields.CharField')(default=5555555555, max_length=25))

    def backwards(self, orm):

        # Changing field 'Person.phone'
        db.alter_column(u'app_person', 'phone', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
