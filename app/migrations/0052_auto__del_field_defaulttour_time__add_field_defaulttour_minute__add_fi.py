...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DefaultTour.time'
        db.delete_column(u'app_defaulttour', 'time')

        # Adding field 'DefaultTour.minute'
        db.add_column(u'app_defaulttour', 'minute',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'DefaultTour.hour'
        db.add_column(u'app_defaulttour', 'hour',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DefaultTour.time'
        db.add_column(u'app_defaulttour', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=0),
                      keep_default=False)

        # Deleting field 'DefaultTour.minute'
        db.delete_column(u'app_defaulttour', 'minute')

        # Deleting field 'DefaultTour.hour'
        db.delete_column(u'app_defaulttour', 'hour')
