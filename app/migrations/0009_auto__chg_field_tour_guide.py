...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tour.guide'
        db.alter_column(u'app_tour', 'guide_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Person'], null=True))

    def backwards(self, orm):

        # Changing field 'Tour.guide'
        db.alter_column(u'app_tour', 'guide_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.Person']))
    ...
    models = {
        ...
        u'app.tour': {
            ...
            'guide': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Person']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
