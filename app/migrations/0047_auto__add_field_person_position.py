...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'app_person', 'position',
                      self.gf('django.db.models.fields.CharField')(default='Regular Member', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.position'
        db.delete_column(u'app_person', 'position')
