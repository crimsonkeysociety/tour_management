...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.person_permissions'
        db.delete_column(u'app_person', 'person_permissions')


    def backwards(self, orm):
        # Adding field 'Person.person_permissions'
        db.add_column(u'app_person', 'person_permissions',
