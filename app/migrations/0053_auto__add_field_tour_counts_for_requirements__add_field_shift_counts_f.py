...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tour.counts_for_requirements'
        db.add_column(u'app_tour', 'counts_for_requirements',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Shift.counts_for_requirements'
        db.add_column(u'app_shift', 'counts_for_requirements',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tour.counts_for_requirements'
        db.delete_column(u'app_tour', 'counts_for_requirements')

        # Deleting field 'Shift.counts_for_requirements'
        db.delete_column(u'app_shift', 'counts_for_requirements')
    ...
    models = {
        ...
        u'app.defaulttour': {
            ...
            'minute': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
        ...
        u'app.overriderequirement': {
            'Meta': {'object_name': 'OverrideRequirement'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'overridden_requirements'", 'to': u"orm['app.Person']"}),
            'semester': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'shifts_required': ('django.db.models.fields.IntegerField', [], {}),
            'tours_required': ('django.db.models.fields.IntegerField', [], {}),
            'year': ('django.db.models.fields.IntegerField', [], {'max_length': '4'})
        },
        u'app.person': {
            ...
            'harvard_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            ...
            'position': ('django.db.models.fields.CharField', [], {'default': "'Regular Member'", 'max_length': '50'}),
            'site_admin': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'person'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"}),
            'year': ('django.db.models.fields.IntegerField', [], {'max_length': '4'})
        },
        u'app.setting': {
        ...
        u'app.shift': {
            ...
            'counts_for_requirements': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
