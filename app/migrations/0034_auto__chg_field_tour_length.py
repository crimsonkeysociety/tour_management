...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tour.length'
        db.alter_column(u'app_tour', 'length', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

    def backwards(self, orm):

        # Changing field 'Tour.length'
        db.alter_column(u'app_tour', 'length', self.gf('django.db.models.fields.IntegerField')(max_length=3))
