...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.default_tour'
        db.delete_column(u'app_person', 'default_tour')

        # Adding field 'Tour.default_tour'
        db.add_column(u'app_tour', 'default_tour',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Person.default_tour'
        db.add_column(u'app_person', 'default_tour',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Tour.default_tour'
        db.delete_column(u'app_tour', 'default_tour')
