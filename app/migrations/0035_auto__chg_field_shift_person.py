...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shift.person'
        db.alter_column(u'app_shift', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.Person']))

    def backwards(self, orm):

        # Changing field 'Shift.person'
        db.alter_column(u'app_shift', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.Person']))
