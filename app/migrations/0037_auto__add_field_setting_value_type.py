...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Setting.value_type'
        db.add_column(u'app_setting', 'value_type',
                      self.gf('django.db.models.fields.CharField')(default='int', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Setting.value_type'
        db.delete_column(u'app_setting', 'value_type')
