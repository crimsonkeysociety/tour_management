...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tour.source'
        cursor.execute('ALTER TABLE app_tour ALTER COLUMN source TYPE integer USING (source::integer)')
        transaction.commit_unless_managed()
        db.alter_column(u'app_tour', 'source', self.gf('django.db.models.fields.IntegerField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Tour.source'
        db.alter_column(u'app_tour', 'source', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'app.tour': {
            ...
            'notes': ('django.db.models.fields.TextField', [], {'max_length': '2000', 'blank': 'True'}),
            'source': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '2'}),
