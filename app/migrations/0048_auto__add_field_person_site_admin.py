...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.site_admin'
        db.add_column(u'app_person', 'site_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.site_admin'
        db.delete_column(u'app_person', 'site_admin')
    ...
    models = {
        ...
        u'app.person': {
            ...
            'site_admin': ('django.db.models.fields.BooleanField', [], {}),
