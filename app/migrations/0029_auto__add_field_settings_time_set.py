...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.time_set'
        db.add_column(u'app_settings', 'time_set',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 30, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settings.time_set'
        db.delete_column(u'app_settings', 'time_set')
