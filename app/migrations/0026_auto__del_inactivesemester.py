...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'app_inactivesemester', (
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inactive_semesters', primary_key=True, to=orm['app.Person'])),
            ('semester', self.gf('django.db.models.fields.CharField')(max_length=6, primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(max_length=4, primary_key=True)),
        ))
