...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OverrideRequirement'
        db.create_table(u'app_overriderequirement', (
            ...
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='overridden_requirements', to=orm['app.Person'])),
            ('tours_required', self.gf('django.db.models.fields.IntegerField')()),
            ('shifts_required', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'app', ['OverrideRequirement'])


    def backwards(self, orm):
        # Deleting model 'OverrideRequirement'
        db.delete_table(u'app_overriderequirement')
