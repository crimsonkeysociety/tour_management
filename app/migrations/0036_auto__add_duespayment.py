...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DuesPayment'
        db.create_table(u'app_duespayment', (
            ...
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dues_payments', to=orm['app.Person'])),
        ))
        db.send_create_signal(u'app', ['DuesPayment'])


    def backwards(self, orm):
        # Deleting model 'DuesPayment'
        db.delete_table(u'app_duespayment')
