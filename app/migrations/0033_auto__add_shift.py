...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Shift'
        db.create_table(u'app_shift', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shifts', null=True, to=orm['app.Person'])),
            ...
            ('length', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True)),
        ))
        db.send_create_signal(u'app', ['Shift'])


    def backwards(self, orm):
        # Deleting model 'Shift'
        db.delete_table(u'app_shift')
    ...
    models = {
        ...
        u'app.shift': {
            ...
            'notes': ('django.db.models.fields.TextField', [], {'max_length': '2000', 'blank': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'shifts'", 'null': 'True', 'to': u"orm['app.Person']"}),
