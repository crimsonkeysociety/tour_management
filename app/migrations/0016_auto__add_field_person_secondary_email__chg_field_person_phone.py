...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.secondary_email'
        db.add_column(u'app_person', 'secondary_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Person.phone'
        db.alter_column(u'app_person', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):
        # Deleting field 'Person.secondary_email'
        db.delete_column(u'app_person', 'secondary_email')


        # Changing field 'Person.phone'
        db.alter_column(u'app_person', 'phone', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
