...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tour.notes'
        db.alter_column(u'app_tour', 'notes', self.gf('django.db.models.fields.TextField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Tour.notes'
        db.alter_column(u'app_tour', 'notes', self.gf('django.db.models.fields.CharField')(max_length=2000))
