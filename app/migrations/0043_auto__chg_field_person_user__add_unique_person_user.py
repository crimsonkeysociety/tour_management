...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_person', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Person', fields ['user']
        db.create_unique(u'app_person', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Person', fields ['user']
        db.delete_unique(u'app_person', ['user_id'])


        # Changing field 'Person.user'
        db.alter_column(u'app_person', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'app.person': {
            ...
            'harvard_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
